...
# 📖 Decode-Morse_Code<a name="about-project"></a>

**Decode-Morse_Code** is a Ruby app for decoding words.
...
This repository includes a file to decode messages:
...
```sh
  git clone `https://github.com/Bellagirl-maker/decode-morse-code.git`
